 ...
 */
public class NewCardMonthDataEntity{
	/**
	 * 
	 */
	...
	private Integer newCardMonthCount;//int(11) NULL 月统计结果
	...
	public Integer getNewCardMonthCount() {
		return newCardMonthCount;
	}
	public void setNewCardMonthCount(Integer newCardMonthCount) {
		this.newCardMonthCount = newCardMonthCount;
	}
