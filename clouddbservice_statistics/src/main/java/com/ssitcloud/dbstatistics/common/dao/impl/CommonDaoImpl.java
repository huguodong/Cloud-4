package com.ssitcloud.dbstatistics.common.dao.impl;
...
import com.ssitcloud.dbstatistics.common.dao.CommonDao;
...
public class CommonDaoImpl implements CommonDao {
	...
	/** (non-Javadoc)
	 * @see com.ssitcloud.dbauth.common.dao.CommonDao#selectAll(String, Object)
	 */
	@Override
	...
	/** (non-Javadoc)
	 * @see com.ssitcloud.dbauth.common.dao.CommonDao#select(String, Object)
	 */
	@Override
	...
	/** (non-Javadoc)
	 * @see com.ssitcloud.dbauth.common.dao.CommonDao#update(String, Object)
	 */
	@Override
	...
	/** (non-Javadoc)
	 * @see com.ssitcloud.dbauth.common.dao.CommonDao#delete(String, Object)
	 */
	@Override
...
//			LogUtils.error("obj is error , the obj is :" + countsObj);
	...
	public int insertBySql(String sql) {
		return sqlSessionTemplate.insert("common.insertBySql",sql);
	}
}
