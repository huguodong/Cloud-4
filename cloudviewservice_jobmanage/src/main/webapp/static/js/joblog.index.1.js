	    ...
	    "columns": [
					{
						...
						"render": function ( data, type, row ) {
							...
							return '<a class="logTips" href="javascript:;" >'+ row.executorHandler +'<span style="display:none;">'+ temp +'</span></a>';
						}
					},
...
var ComAlertTec = {
	html:function(){
		var html =
			...
			'<div class="modal-body"><div class="alert" style="color:#666;"></div></div>' +
