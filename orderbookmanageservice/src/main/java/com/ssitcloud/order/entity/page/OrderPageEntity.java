package com.ssitcloud.order.entity.page;
...
public class OrderPageEntity extends DatagridPageEntity{
	...
	public String toString() {
		return "OrderPageEntity [idx=" + idx + ", book_barcode=" + book_barcode
