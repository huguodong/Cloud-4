...
<div class="equipment-fenzu">
	<form method="post" id="submit" action="../common/exportExcel.do">
	...
	<div class="page-title-bar">
		...
		<div class="form-wrap fr">
			...
			<div class="btn import g-btn-blue" id="import">标签加工数据导入</div>
		</div>
	</div>
	<div class="main">
		...
		//获取当前页数
			...
			success:function(data){
				...
				$.each(data.result.rows,function(i,item){
					$("tbody").append(
					"<tr>"+
	            		"<td class='col1'><div class='g-checkbox'><input type='checkbox' name='idx' id='"+item.shelflayer_idx+"' /></div></td>"+
	...
	**/
	...
	$("#export").on("click",function(){
		...
		var param = {"shelflayer_barcode":shelflayer_barcode,
				"lib_id":''};
		$.ajax({
			url:basePath+"/bookshelflayer/exportBookshelflayer",
			type:"POST",
			data:{"req":JSON.stringify(param),},
			success:function(data){
				var title = "书架数据";
				...
				$("#dataset").val(JSON.stringify(data.result));
