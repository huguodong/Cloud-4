...
public interface CommonDao {
	...
	/**
	 * 獲取數據回話操作模板
	 * @methodName: getSqlSessionTemplate
	 * @return
	 * @returnType: SqlSessionTemplate
	 * @author: liuBh
	 */
	SqlSession getSqlSession();
	
	public abstract <T> List<T> selectList(String sqlName, T t);

	/*public abstract List<Map<String, Object>> selectList2(String string,
			Map<String, Object> m);*/

	public abstract int selectOne(String string, Map<String, Object> map);

	public abstract int insertBySql(String sqlString);

	public abstract List<Map<String, Object>> selectBySql(String sql);
