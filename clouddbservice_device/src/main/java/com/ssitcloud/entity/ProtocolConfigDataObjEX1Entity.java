...
public class ProtocolConfigDataObjEX1Entity {
	...
	private List<ACSProtocolEntity> protocol_config_arr;//详细配置信息
	...
	public List<ACSProtocolEntity> getProtocol_config_arr() {
		return protocol_config_arr;
	}
	public void setProtocol_config_arr(
			List<ACSProtocolEntity> protocol_config_arr) {
