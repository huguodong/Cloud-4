 ...
 *
 */
public class MaintenanceCardPageEntity extends DatagridPageEntity<MaintenanceCardPageEntity>{
	...
	private List<String> lib_idxs;//模糊查询用
	
	
	
	
	
	public List<String> getLib_idxs() {
		return lib_idxs;
	}
	public void setLib_idxs(List<String> lib_idxs) {
		this.lib_idxs = lib_idxs;
	}
