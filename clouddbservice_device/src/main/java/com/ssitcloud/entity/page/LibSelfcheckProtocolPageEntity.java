...
public class LibSelfcheckProtocolPageEntity extends DatagridPageEntity<LibSelfcheckProtocolPageEntity>{
	...
	public String getProtocol_start() {
		return protocol_start;
	}
	public void setProtocol_start(String protocol_start) {
		this.protocol_start = protocol_start;
	}
	public String getProtocol_end() {
		return protocol_end;
	}
	public void setProtocol_end(String protocol_end) {
