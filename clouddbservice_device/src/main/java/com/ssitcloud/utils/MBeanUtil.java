...
public class MBeanUtil {
	...
	public static void main(String[] args) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException, IntrospectionException {
		DeviceRunConfigRemoteEntity dcre=new DeviceRunConfigRemoteEntity();
		
		dcre.setRun_conf_type("dev_config");
		
		dcre.setRun_conf_value("{dsadasdasdasdas}");
		
		System.out.println(bean2Map(dcre));
	}
	/**
