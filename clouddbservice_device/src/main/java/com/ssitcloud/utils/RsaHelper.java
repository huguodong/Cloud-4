...
//     * @return
//     */
//	private static DBUtils dbPool=new DBUtils();
...
//
//
//		String sql = "Select b_Notes from para_basic where b_Type='PrivateKey' ";
...
//			while (rs.next()) {
//				strRet=DataInfoUtil.getResultSetString(rs, "b_Notes");
//			}
//			rs.close();
//			pstmt.close();
//		} catch (Exception e) {
//			LogUtils.error("Dao-impl-getKey出错" + e.getMessage());
...
//				}catch(Exception ex)
//				{
//					LogUtils.error("Dao-impl-getKey-close出错" + ex.getMessage());
//				}
//		}
//
//	
...
//
//
//		String sql = "Select b_Notes from para_basic where b_Type='Code' ";
//		PreparedStatement pstmt = null;
//		ResultSet rs = null;
//		Connection con = dbPool.getConnection();
//		try {
...
//			pstmt.close();
//		} catch (Exception e) {
//			LogUtils.error("Dao-impl-getData出错" + e.getMessage());
//			throw new RuntimeException(e);
//		} finally {
//			try{
//				dbPool.closeAll(con, pstmt, rs);
//				}catch(Exception ex)
//				{
//					LogUtils.error("Dao-impl-getData-close出错" + ex.getMessage());
//				}
//		}
//
//	
