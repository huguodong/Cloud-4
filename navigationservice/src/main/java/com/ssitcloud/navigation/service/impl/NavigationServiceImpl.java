...
public class NavigationServiceImpl implements NavigationService {
	...
	@Override
	public NavigationInfoEntity queryInfoByParam(BookitemEntity bookitemEntity) {
	...
	@Override
	public BookitemEntity queryBookInfo(String bookBarCode) {
		BookitemEntity bookitem = new BookitemEntity();
		bookitem.setBook_barcode(bookBarCode);
		BookitemEntity ety = bookitemDao.queryBookitemByCode(bookitem);
		return ety;
	}
