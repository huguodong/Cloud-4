...
<body>
    <div class="page-top"><div id="lmsg"><%-- ${locations[0]}馆 --%>${locations[1]}楼${locations[2]}区${locations[3]}排${locations[4]}面${locations[5]}列
    	<c:if test="${navigationInfoEty.layercount == '1'}">1</c:if>
    	<c:if test="${navigationInfoEty.layercount == '2'}">1~2</c:if>
    	<c:if test="${navigationInfoEty.layercount == '3' and navigationInfoEty.shelf_layer == '1'}">1~2</c:if>
    	<c:if test="${navigationInfoEty.layercount == '3' and navigationInfoEty.shelf_layer == '2'}">3</c:if>
    	<c:if test="${navigationInfoEty.layercount == '4' and navigationInfoEty.shelf_layer == '1'}">1~2</c:if>
    	<c:if test="${navigationInfoEty.layercount == '4' and navigationInfoEty.shelf_layer == '2'}">3~4</c:if>
    	<c:if test="${navigationInfoEty.layercount == '5' and navigationInfoEty.shelf_layer == '1'}">1~2</c:if>
    	<c:if test="${navigationInfoEty.layercount == '5' and navigationInfoEty.shelf_layer == '2'}">3~5</c:if>
    	<c:if test="${navigationInfoEty.layercount == '6' and navigationInfoEty.shelf_layer == '1'}">1~3</c:if>
    	<c:if test="${navigationInfoEty.layercount == '6' and navigationInfoEty.shelf_layer == '2'}">4~6</c:if>
    	层</div></div>
    	<input type="hidden" value="<%-- ${locations[0]}馆 --%>${locations[1]}楼${locations[2]}区${locations[3]}排${locations[4]}面${locations[5]}列<c:if test="${navigationInfoEty.layercount == '1'}">1</c:if><c:if test="${navigationInfoEty.layercount == '2'}">1~2</c:if><c:if test="${navigationInfoEty.layercount == '3' and navigationInfoEty.shelf_layer == '1'}">1~2</c:if><c:if test="${navigationInfoEty.layercount == '3' and navigationInfoEty.shelf_layer == '2'}">3</c:if><c:if test="${navigationInfoEty.layercount == '4' and navigationInfoEty.shelf_layer == '1'}">1~2</c:if><c:if test="${navigationInfoEty.layercount == '4' and navigationInfoEty.shelf_layer == '2'}">3~4</c:if><c:if test="${navigationInfoEty.layercount == '5' and navigationInfoEty.shelf_layer == '1'}">1~2</c:if><c:if test="${navigationInfoEty.layercount == '5' and navigationInfoEty.shelf_layer == '2'}">3~5</c:if><c:if test="${navigationInfoEty.layercount == '6' and navigationInfoEty.shelf_layer == '1'}">1~3</c:if><c:if test="${navigationInfoEty.layercount == '6' and navigationInfoEty.shelf_layer == '2'}">4~6</c:if>层" id="locationMsgInput"/>
    <div class="page-down">
...
<script>
    window.onload = function(){
        ...
        function FadeText()
        {
            ...
            {
                i--;
                document.getElementById("lmsg").style.color='#000000';
                if( i==0 ) add=1;
            }
        };
		...
		var org_x = parseInt(parseInt(document.getElementById("route_xx1").innerHTML)*line_factor_x);
		var org_y = parseInt(parseInt(document.getElementById("route_yy1").innerHTML)*line_factor_y);
		var dest_x = parseInt(parseInt(document.getElementById("route_xx" + String(nos)).innerHTML)*line_factor_x);
        var dest_y = parseInt(parseInt(document.getElementById("route_yy" + String(nos)).innerHTML)*line_factor_y);
            ...
            function TM(){
                setInterval(function(){
                    if ( i < nos ) {
                        ...
                        ctx.lineWidth = 2;
                        ctx.lineCap = 'round';
                		org_x = parseInt(parseInt(document.getElementById("route_xx" + String(i)).innerHTML)*line_factor_x);
                        org_y = parseInt(parseInt(document.getElementById("route_yy" + String(i)).innerHTML)*line_factor_y);
                        ctx.moveTo(org_x, org_y);
                        dest_x = parseInt(parseInt(document.getElementById("route_xx" + String(i+1)).innerHTML)*line_factor_x);
                        dest_y = parseInt(parseInt(document.getElementById("route_yy" + String(i+1)).innerHTML)*line_factor_y);
