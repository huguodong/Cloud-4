...
public class CollectionUtils {
	 ...
	 * @return {@code true} if the specified {@code Collection} is {@code null} or {@link Collection#isEmpty empty}, {@code false} otherwise.
	 * @since 1.0
	 */
	 ...
	 * @return {@code true} if the specified {@code Map} is {@code null} or {@link Map#isEmpty empty}, {@code false} otherwise.
	 * @since 1.0
	 */
