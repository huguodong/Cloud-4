 ...
 * @package: com.ssitcloud.datasync.entity
 * @classFile: DownloadOsbSynResultEntity
 * @description: TODO
 */
public class DownloadOsbSynResultEntity {
	...
	public DownloadOsbSynResultEntity() {
	}
	public DownloadOsbSynResultEntity(String device_id, String library_id,String table,
