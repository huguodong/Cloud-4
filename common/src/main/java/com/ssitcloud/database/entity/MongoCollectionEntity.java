...
public class MongoCollectionEntity implements Serializable {
  ...
  private Integer server_id = null;
  
	public MongoCollectionEntity() {

	}

	public MongoCollectionEntity(String name) {
		this.name = name;
	}

	public MongoCollectionEntity(String databaseName, String name) {
