package com.ssitcloud.businessauth.common.system;
...
import com.ssitcloud.businessauth.utils.SendHearbeatUtil;
...
public class StatisticHelper {
	...
	@Pointcut("execution(public * com.ssitcloud.businessauth..*.*(..))")
