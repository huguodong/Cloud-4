...
<%@ taglib prefix="s" uri="http://www.springframework.org/tags" %>	
	...
	<div class="form-dialog-fix w-900 yingjian">
		...
		<div class="form-dialog">
			<div class="title">
				<!-- 修改配置 -->
				<s:message code="Tempedit.jsp.ModifyConf"/>
				<input type="reset" value="<s:message code="message.gloable.cancel"/>" class="g-cancel2 g-btn-gray">
				<input type="submit" placeholder="" id="extTempSave"   class="g-submit2 g-btn-green" value="<s:message code="message.gloable.save"/>">
			...
			<div class="left-tab" id="ext_left_tab">
				...
				<%--
				 ...
				 --%>
					<li class="active" id="AuthorityBarcode"><s:message code="Tempedit.jsp.AuthorityBarcode"/></li>
					<li id="AuthorityReader"><s:message code="Tempedit.jsp.AuthorityReader"/></li>
					<li id="CardDispenser"><s:message code="Tempedit.jsp.CardDispenser"/></li>
					<li id="CashAcceptor"><s:message code="Tempedit.jsp.CashAcceptor"/></li>
					<li id="IdentityReader"><s:message code="Tempedit.jsp.IdentityReader"/></li>
					<li id="ItemBarcode"><s:message code="Tempedit.jsp.ItemBarcode"/></li>
					<li id="ItemLoadReader"><s:message code="Tempedit.jsp.ItemLoadReader"/></li>
					<li id="ItemRfidReader"><s:message code="Tempedit.jsp.ItemRfidReader"/></li>
					<li id="DevicePLC"><s:message code="Tempedit.jsp.Plc"/></li>
<!-- 					<li id="PlcSorter">分拣机PLC</li> -->
<!-- 					<li id="PlcSSL">自助图书馆PLC</li> -->
					<li id="Printer"><s:message code="Tempedit.jsp.Printer"/></li>
					<li id="RegisterReader"><s:message code="Tempedit.jsp.RegisterReader"/></li>
				</ul>
			</div>
					...
					<div class="form-wrap form-wrap2">
						<ul>
							...
							<li style="display:none">
								<div class="left"><s:message code="Tempedit.jsp.tempId"/></div>
								<div class="right">
									<input type="text" name="" id="AuthorityBarcode_id" class="g-input" value="<s:message code="Tempedit.jsp.AuthorityBarcode"/>" readonly="readonly" style="color: gray;background-color: #E0E0E0"
										placeholder="<s:message code="Tempedit.jsp.pleaseInput"/>" /> <span class="error-msg"><s:message code="Tempedit.jsp.errmsg"/></span>
								</div>
							</li>
							<li>
								<div class="left"><s:message code="Tempedit.jsp.logicName"/></div>
								<div class="right">
									<div class="g-select" >
										<select id="AuthorityBarcode_logicName" class="logicname">
											<option value="-1" disabled="disabled"><s:message code="Tempedit.jsp.pleaseChoice"/></option>
							...
							<li>
								<div class="left"><s:message code="Tempedit.jsp.roundItem"/></div>
								<div class="right">
									<div class="g-select">
										<select id="AuthorityBarcode_extModel" class="need-change extmodel">
											<option value="-1" selected><s:message code="Tempedit.jsp.pleaseChoice"/></option>
										</select> <span class="arr-icon"></span>
									</div>
								</div>
							</li>
							...
							<li>
								<div class="left"><s:message code="Tempedit.jsp.CommunicationMode"/></div>
								<div class="right">
									<div class="g-select">
										<select id="AuthorityBarcode_comm" class="need-change">
											<option value="-1"><s:message code="Tempedit.jsp.ChoiceCommunicationMode"/></option>
							...
							<li>
								<div class="changebox" date-id="AuthorityBarcode_comm" val="com">
									<ul>
										<li>
											<div class="left"><s:message code="Tempedit.jsp.COM"/></div>
											<div class="right">
												<input type="text" name="" id="AuthorityBarcode_COM" class="g-input"
													placeholder="<s:message code="Tempedit.jsp.pleaseInput"/>" />
											</div>
										</li>
										<li>
											<div class="left"><s:message code="Tempedit.jsp.BaudRate"/></div>
											<div class="right">
								...
								<div class="changebox" date-id="AuthorityBarcode_comm" val="usb">
									<ul>
										<li>
											<div class="left"><s:message code="Tempedit.jsp.USB"/></div>
											<div class="right">
								...
								<div class="changebox" date-id="AuthorityBarcode_comm" val="net">
									<ul>
										<li>
											<div class="left"><s:message code="Tempedit.jsp.IP"/></div>
											<div class="right">
										...
										<li>
											<div class="left"><s:message code="Tempedit.jsp.Port"/></div>
											<div class="right">
					...
					<div class="form-wrap form-wrap2">
						<ul>
							...
							<li style="display:none">
								<div class="left"><s:message code="Tempedit.jsp.tempId"/></div>
								<div class="right">
									<input type="text" name="" id="" class="g-input" value="<s:message code="Tempedit.jsp.AuthorityReader"/>" readonly="readonly" style="color: gray;background-color: #E0E0E0"
										placeholder="<s:message code="Tempedit.jsp.pleaseInput"/>" /> <span class="error-msg"><s:message code="Tempedit.jsp.errmsg"/></span>
								</div>
							</li>
							<li>
								...
								<div class="right">
									<div class="g-select">
										<select id="AuthorityReader_logicName" class="logicname">
											<option value="" selected><s:message code="Tempedit.jsp.pleaseChoice"/></option>
										</select> <span class="arr-icon"></span>
									</div>
								</div>
							</li>
							...
							<li style="display:none">
								...
								<div class="right">
									<input type="text" name="" id="" class="g-input" value="发卡机" readonly="readonly" style="color: gray;background-color: #E0E0E0"
										placeholder="<s:message code="Tempedit.jsp.pleaseInput"/>" /> <span class="error-msg">错误提示</span>
								</div>
							</li>
							<li>
					...
					<div class="form-wrap form-wrap2">
						<ul>
							...
							<li style="display:none">
								<div class="left">模板ID</div>
								<div class="right">
									<input type="text" name="" id="" class="g-input" value="Switcher开关" readonly="readonly" style="color: gray;background-color: #E0E0E0"
										placeholder="<s:message code="Tempedit.jsp.pleaseInput"/>" /> <span class="error-msg">错误提示</span>
								</div>
							</li>
							<li>
...
<!-- 								<div class="left">模板ID</div> -->
<!-- 								<div class="right"> -->
<!-- 									<input type="text" name="" id="" class="g-input" placeholder="<s:message code="Tempedit.jsp.pleaseInput"/>" /> -->
						 			...
						 			<ul plcLogicObjIdx="${plcLogicObj.plc_logic_obj_idx}">
										...
										<c:if test="${fn:startsWith(plcLogicObj.plc_logic_obj,'Drawer')}">
											<li>
												...
												<div class="right">
													<input type="text" name="threshold" id="" class="g-input" placeholder="<s:message code="Tempedit.jsp.pleaseInput"/>"  />
						 	 ...
						 	 <ul>
								...
								<c:if test="${metadataLogicObject.logic_obj eq 'CashAcceptor'}">
									<li>
										...
										<div class="right">
											<input type="text"  name="threshold" id="threshold-rmb-num" class="g-input" placeholder="<s:message code="Tempedit.jsp.pleaseInput"/>"  />
