...
<div class="g-header">
	...
	<a class="exit" href="${pageContext.request.contextPath}/index.jsp"><span class="icon"></span>退出</a>
	...
	<a href="${pageContext.request.contextPath}/index.jsp" class="index-page"><span class="icon"></span>首页</a>
</div>
<div class="no-page">
	<div class="word">
		抱歉，请求的资源不再您的权限范围<br>
		请联系系统管理员<br>
		或者 <a class="back-to-index" href="${pageContext.request.contextPath}/index.jsp">返回首页</a>
	</div>
</div>
