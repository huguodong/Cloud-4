...
<div class="main-content" style="backgroud-color:white">
    <div class="left-side">
        ...
        <div class="absolute-wrap" style="visibility: hidden;">
...
<script type="text/javascript">
    ...
    function getUserMenu(){
        html+="<div class=\"item\">";
       	...
       	html+="	<li><a href=\"javascript:void(0)\" data-url=\"${pageContext.request.contextPath}/page/devmgmt/virtualLib.jsp\">设备监控</a></li>";
       	html+="</ul>";
       	html+="</div>";
