...
;(function ($, window, document, undefined) {
	...
	_default.settings = {
		...
		collapseIcon: 'glyphicon glyphicon-chevron-down',//'glyphicon glyphicon-minus',
		emptyIcon: 'glyphicon',
	...
	*/
	...
	Tree.prototype.buildTree = function (children, level) {
		...
		$.each(children, function addNodes(id, node) {
			//alert(JSON.stringify($(_this.template)));
			...
			//var treeLink = $(_this.template.link)
			...
			if (_this.options.enableLinks) {
				// Add hyperlink
				var link_id=node.link_id?node.link_id:node.id+'_anchor';
				treeItem
	...
	Tree.prototype.css = '.treeview .list-group-item{cursor:pointer;white-space:nowrap;}.treeview span.indent{margin-left:8px;margin-right:8px}.treeview span.icon{margin-right:5px}.treeview .node-disabled{color:silver;cursor:not-allowed}'
