...
/*
	...
	/*在翻页 或者查询的时候 清除全选checkbox*/
	function clearCheckbox(){
		$checkbox=$(".g-table th .g-checkbox").find("input[type=checkbox]");
		if($checkbox.is(":checked")){
			$checkbox.removeAttr("checked").parents(".g-checkbox").removeClass("on")
		}
	}
	/**
	动态分页控件
