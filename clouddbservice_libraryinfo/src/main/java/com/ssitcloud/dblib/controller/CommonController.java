...
public class CommonController {
	...
	@RequestMapping(value="uploadLibraryInfoFile")
    @ResponseBody
    public ResultEntity uploadLibraryInfoFile(HttpServletRequest request,HttpServletResponse response, String libId, String deviceId) throws IOException{
		ResultEntity result=new ResultEntity();
		//创建一个通用的多部分解析器  
        CommonsMultipartResolver multipartResolver = new CommonsMultipartResolver(request.getSession().getServletContext());  
        //判断 request 是否有文件上传,即多部分请求  
