...
public class UserSerivceImpl extends BasicServiceImpl implements UserService{
	...
	public String logincheck(String json){
		...
		String username = PropertiesUtil.getConfigPropValueAsText("username");
		String passwd = PropertiesUtil.getConfigPropValueAsText("passwd");
		if(username.equals(user.getOperator_id()) && passwd.equals(user.getOperator_pwd())){
