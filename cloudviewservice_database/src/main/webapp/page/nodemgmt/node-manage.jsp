...
<script type="text/javascript">
	...
	jQuery.innerHtml = function(rows,flag) {
		$.each(rows,function(i, item) {
			...
			if(item.node_attributes=='primary'){
				_html="<span class='btn-a edit primary-edit'>编辑</span><span class='btn-a delete'>删除</span><span class='btn-a g-btn-green create'>创建从节点</span>";
			}
