...
public class JsonUtils {
	 ...
	 * 
	 *
	 * <p>2017年4月21日 下午4:40:11 
	 * <p>create by hjc
	 * @param json
	 * @return
	 */
	public static <T> T fromJson(String json, Class<T> valueType, String format) {
		json = replaceJsonStrNull(json);
		if(json==null||"".equals(json))return null;
		T obj = null;
		try {
	 ...
	 * @param valueTypeRef
	 */
	public static <T> T fromJson(Object obj, TypeReference<T> valueTypeRef) {
		if (obj == null)return null;
		T t = null;
		try {
	...
	public static <T> T fromJson(String json,TypeReference<T> valueTypeRef, String format) {
		json = replaceJsonStrNull(json);
		if(json==null||"".equals(json))return null;
		T obj = null;
		try {
