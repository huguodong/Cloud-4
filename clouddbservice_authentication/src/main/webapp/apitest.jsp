...
<body style="width: 80%;padding-left: 15%">
	...
	<ul id="library" style="display: none">
		...
		<li><a href="javascript: void(0)" onclick="addNewLibrary(this)">/library/addNewLibrary</a></li>
		<li><a href="javascript: void(0)" onclick="modifyLibraty(this)">/library/modifyLibraty</a></li>
	</ul>
	...
	<ul id="operator" style="display: none">
		<li><a href="javascript: void(0)" onclick="addOperator(this)">/operator/addOperator</a></li>
...
function change(obj){
	...
	function addOperator(obj) {
		...
		var param = 'operInfo={' + '"operator_id":"ss",' + '"library_idx":"1",'
	...
	function getVaildTime(obj) {
		$("#submit").removeAttr("disabled");
		$("#selectText").html($(obj).text());
		$("#param").val('operInfo={"operator_id":"1"}');
	}
	...
	function delOperatorByIdx(obj) {
		$("#submit").removeAttr("disabled");
		$("#selectText").html($(obj).text());
		var param = 'operInfo={' + '"operator_idx":"9"'
	...
	function updOperatorByIdx(obj) {
		$("#submit").removeAttr("disabled");
		$("#selectText").html($(obj).text());
		var param = 'operInfo={' + '"operator_idx":"3",'
	...
	function updOperatorByParam(obj) {
		$("#submit").removeAttr("disabled");
		$("#selectText").html($(obj).text());
		var param = 'updParam={' + '"operator_id":"67",' + '"library_idx":"1",'
	...
	function loginCheck(obj) {
		$("#submit").removeAttr("disabled");
		$("#selectText").html($(obj).text());
		var param = 'operInfo={' + '"operator_id":"67",'
				+ '"operator_pwd":"123",' + '"ip":"127.0.0.1",'
				+ '"port":"10086",' + '"faild_times":"0"' + '}';
		$("#param").val(param);
	}
