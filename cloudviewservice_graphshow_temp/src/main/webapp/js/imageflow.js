...
function ImageFlow() {
    ...
    this.defaults =
	{
	    ...
	    imagesM: 1.0,            /* 图片深度 */
	    onClick: function () { return },   /* Onclick behaviour */
    ...
    this.refresh = function () {
        ...
        this.imagesDivHeight = Math.round($("#chart_borrowAndReturn").height() * my.imagesHeight);
        // 修改了这里
        /* Change imageflow div properties */
        // my.ImageFlowDiv.style.height = my.maxHeight + 'px';
        my.ImageFlowDiv.style.height = $("#chart_borrowAndReturn").height() + 'px';
...
domReady(function ()
{
    $("#starsIF").css("height", $("#chart_borrowAndReturn").height());
